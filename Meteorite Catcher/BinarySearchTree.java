...
public class BinarySearchTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    protected static class Node<T> {
        ...
        public boolean isLeftChild() {
            return this.up != null && this.up.down[0] == this;
        }
    ...
    protected void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        //checks if the parent or child is null and throws the error.
        if (child == null || parent == null) {
            throw new IllegalArgumentException("Child and parent nodes must not be null.");
        }
        //checks if the child and parent are related and throws the error.
        if (child.up != parent)
            throw new IllegalArgumentException("The child and parent are not related");

        Node<T> grandparent = parent.up;//stores the parent of the parent
        boolean isLeftChild = parent.down[0] == child;//checks if the parent is the left child.

        //switches the parent and child's position appropriately.
        if (grandparent != null) {
            ...
            root = child;//if the grandparent is null, makes the child as root
        }

        if (isLeftChild) {//if parent is the left child
            parent.down[0] = child.down[1];
            if (child.down[1] != null) {
                child.down[1].up = parent;
            }
            child.down[1] = parent;//right child is the parent
            parent.up = child;
        } else {//if parent is the right child
            parent.down[1] = child.down[0];
            if (child.down[0] != null) {
                child.down[0].up = parent;
            }
            child.down[0] = parent;//left child is the parent
            parent.up = child;
        }
    }
    ...
    public static boolean test1() {
        //This method creates a BST and tests the rotate method by performing a right
        ...
        bstTest.rotate(bstTest.root.down[0], bstTest.root);
        String expected = "level order: [ 27, 18, 41, 34, 68, 52, 77 ]" +
                "\nin order: [ 18, 27, 34, 41, 52, 68, 77 ]";
        String actual = bstTest.toString();
        //Checks if the expected bst matches the actual bst
    ...
    public static boolean test2() {
        // This method performs a left rotation by rotating parent and the right child at the root.
        BinarySearchTree<Integer> bstTest = new BinarySearchTree<>();
        bstTest.insert(41);
        bstTest.insert(27);
        bstTest.insert(68);
        ...
        //performs a right rotation
        bstTest.rotate(bstTest.root.down[1], bstTest.root);
    ...
    public static boolean test3() {
        // This method checks for the right rotation within the left subtree of the BST.
        ...
        //Rotating in the left subtree of the BST.
        bstTest.rotate(bstTest.root.down[0].down[0], bstTest.root.down[0]);
    ...
    public static boolean test4() {
        // This method checks for the left rotation within the right subtree of the BST.
        ...
        //Rotating in the right subtree of the BST.
        bstTest.rotate(bstTest.root.down[1].down[1], bstTest.root.down[1]);
        String expected = "level order: [ 41, 27, 77, 18, 34, 68, 52 ]" +
                "\nin order: [ 18, 27, 34, 41, 52, 68, 77 ]";
        String actual = bstTest.toString();
        //Checks if the expected bst matches the actual bst
        if (!expected.equals(actual))
    ...
    public static boolean test5() {
        //Checks for left rotation in the left subtree of the BST.
        BinarySearchTree<Integer> bstTest = new BinarySearchTree<>();
        bstTest.insert(41);
        bstTest.insert(27);
        bstTest.insert(68);
    ...
    public static boolean test6() {
        //This test method checks for unrelated values of child and parent.
        BinarySearchTree<Integer> bstTest = new BinarySearchTree<>();
        bstTest.insert(41);
        bstTest.insert(27);
        bstTest.insert(68);
        ...
        bstTest.insert(77);
        try {
            bstTest.rotate(bstTest.root.down[0], bstTest.root.down[1]);
            return false;//should return false if the block did not catch any error.
        } catch (IllegalArgumentException e) {
            if (e.getMessage() == null || e.getMessage().isBlank())
                return false;//returns false if the right exception is not caught.
        } catch (Exception e) {
            //checks if unexpected exception is caught.
            //e.printStackTrace();
            return false;
        }
        return true;
